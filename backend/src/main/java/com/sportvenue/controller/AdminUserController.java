...
public class AdminUserController {
    ...
    /**
     * UC-ADM-03: Cập nhật trạng thái tài khoản (Khoá / Mở khoá).
     */
    @GetMapping("/users/{id}/lock")
    @Operation(summary = "Khoá tài khoản", description = "Đổi trạng thái tài khoản thành BLOCKED")
    public ResponseEntity<ApiResponse<Void>> lockUser(@Parameter(description = "ID người dùng") @org.springframework.web.bind.annotation.PathVariable Integer id) {
        adminUserService.updateUserStatus(id, AccountStatus.BLOCKED);
    ...
    @GetMapping("/users/{id}/unlock")
    @Operation(summary = "Mở khoá tài khoản", description = "Đổi trạng thái tài khoản thành ACTIVE")
    public ResponseEntity<ApiResponse<Void>> unlockUser(@Parameter(description = "ID người dùng") @org.springframework.web.bind.annotation.PathVariable Integer id) {
        adminUserService.updateUserStatus(id, AccountStatus.ACTIVE);
        return ResponseEntity.ok(ApiResponse.<Void>builder()
                .code(200)
