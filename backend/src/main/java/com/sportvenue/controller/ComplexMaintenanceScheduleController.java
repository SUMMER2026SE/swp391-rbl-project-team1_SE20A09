...
public class ComplexMaintenanceScheduleController {
    ...
    @Operation(summary = "List maintenance schedule history for a complex")
    public ResponseEntity<List<MaintenanceScheduleResponse>> listComplexSchedules(@PathVariable Integer complexId) {
        return ResponseEntity.ok(maintenanceScheduleService.listComplexSchedules(complexId));
    }
}
