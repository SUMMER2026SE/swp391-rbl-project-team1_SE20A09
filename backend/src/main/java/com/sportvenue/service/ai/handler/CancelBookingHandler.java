...
public class CancelBookingHandler {
    ...
    public AiChatTurnResponse handle(JsonNode args, String message, Integer userId) {
        ...
        // Lấy danh sách booking có thể hủy (PENDING, PENDING_PAYMENT, CONFIRMED)
        ...
        if (bookings.isEmpty()) {
            return AiChatTurnResponse.builder()
                    ...
                    .message("Bạn không có đơn đặt sân nào có thể hủy. Các đơn đã hoàn thành hoặc đã bị hủy không thể hủy được.")
                    .bookings(List.of())
                    .build();
        }
        ...
        return AiChatTurnResponse.builder()
                .intent("cancel_booking")
                .message("Đây là các đơn đặt sân sắp tới của bạn. Bạn muốn hủy đơn nào? (Vui lòng nói rõ mã đơn hoặc sân bạn muốn hủy)")
