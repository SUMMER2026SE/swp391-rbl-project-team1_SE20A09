...
public interface AdminUserService {
    ...
    /**
     * Cập nhật trạng thái tài khoản của người dùng (Lock/Unlock/Activate).
     * UC-ADM-03: Lock/Unlock Customer
     * UC-ADM-05: Lock/Unlock Owner
     *
     * @param userId        ID của người dùng cần cập nhật
     * @param newStatus     trạng thái mới (ACTIVE, BLOCKED)
     */
    void updateUserStatus(Integer userId, AccountStatus newStatus);
}
