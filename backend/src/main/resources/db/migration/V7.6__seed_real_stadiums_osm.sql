jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/12201296/pexels-photo-12201296.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 559000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 559000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/36774665/pexels-photo-36774665.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/3660204/pexels-photo-3660204.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/8286363/pexels-photo-8286363.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 462000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 462000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 494000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 494000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/9488949/pexels-photo-9488949.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/30619256/pexels-photo-30619256.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 387000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 387000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/46792/the-ball-stadion-football-the-pitch-46792.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/13434565/pexels-photo-13434565.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 587000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 587000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/6010282/pexels-photo-6010282.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/30617588/pexels-photo-30617588.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/30894524/pexels-photo-30894524.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 291000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 291000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 580000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 580000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 340000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 340000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/36127007/pexels-photo-36127007.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/27151849/pexels-photo-27151849.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/27151849/pexels-photo-27151849.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/36034890/pexels-photo-36034890.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/8979885/pexels-photo-8979885.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/9739466/pexels-photo-9739466.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/8286363/pexels-photo-8286363.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/3660204/pexels-photo-3660204.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/8980690/pexels-photo-8980690.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/35984242/pexels-photo-35984242.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 213000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 213000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/3660204/pexels-photo-3660204.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/8007173/pexels-photo-8007173.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/26238656/pexels-photo-26238656.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 75000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/8007094/pexels-photo-8007094.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/35647228/pexels-photo-35647228.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/26238656/pexels-photo-26238656.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/8007075/pexels-photo-8007075.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 89000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 89000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/4328745/pexels-photo-4328745.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/15362139/pexels-photo-15362139.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 69000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 69000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/4582494/pexels-photo-4582494.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/27151849/pexels-photo-27151849.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 192000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 192000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 342000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 342000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 464000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 464000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/13425628/pexels-photo-13425628.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/8224638/pexels-photo-8224638.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/6931243/pexels-photo-6931243.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/13434565/pexels-photo-13434565.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/4328745/pexels-photo-4328745.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/47343/the-ball-stadion-horn-corner-47343.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/46792/the-ball-stadion-football-the-pitch-46792.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 304000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 304000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 476000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 476000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        (SELECT sport_type_id FROM sport_types WHERE sport_name = 'Football'),
        'Sân Vận Động', 'Dữ liệu thực tế tổng hợp từ OpenStreetMap.', 'FACILITY', complex_id,
        '06:00', '22:00', 438000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 438000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 313000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 313000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/6931243/pexels-photo-6931243.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 224000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 224000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/6010279/pexels-photo-6010279.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/5666179/pexels-photo-5666179.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/36127007/pexels-photo-36127007.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/6931243/pexels-photo-6931243.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/13425628/pexels-photo-13425628.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        (SELECT sport_type_id FROM sport_types WHERE sport_name = 'Tennis'),
        'Lan Anh', 'Dữ liệu thực tế tổng hợp từ OpenStreetMap.', 'FACILITY', complex_id,
        '06:00', '22:00', 279000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 279000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 517000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 517000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/14317118/pexels-photo-14317118.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/13434565/pexels-photo-13434565.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 554000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 554000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/8007493/pexels-photo-8007493.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/8007173/pexels-photo-8007173.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/5666179/pexels-photo-5666179.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        (SELECT sport_type_id FROM sport_types WHERE sport_name = 'Tennis'),
        'Sân tennis', 'Dữ liệu thực tế tổng hợp từ OpenStreetMap.', 'FACILITY', complex_id,
        '06:00', '22:00', 223000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 223000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 489000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 489000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/46792/the-ball-stadion-football-the-pitch-46792.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/4328745/pexels-photo-4328745.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/5739120/pexels-photo-5739120.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/5666179/pexels-photo-5666179.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/9739466/pexels-photo-9739466.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/37143606/pexels-photo-37143606.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/8980690/pexels-photo-8980690.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 260000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/5739120/pexels-photo-5739120.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/30617588/pexels-photo-30617588.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 501000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 501000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/9739462/pexels-photo-9739462.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 161000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 161000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 563000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 563000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 222000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 222000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/6203632/pexels-photo-6203632.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/36382714/pexels-photo-36382714.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/6203582/pexels-photo-6203582.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/36034890/pexels-photo-36034890.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/36127007/pexels-photo-36127007.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/6010279/pexels-photo-6010279.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/5739120/pexels-photo-5739120.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/27151849/pexels-photo-27151849.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/13425628/pexels-photo-13425628.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 226000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 226000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/46792/the-ball-stadion-football-the-pitch-46792.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 520000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 520000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/27669822/pexels-photo-27669822.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/17160683/pexels-photo-17160683.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/36382714/pexels-photo-36382714.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/6203533/pexels-photo-6203533.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/6203568/pexels-photo-6203568.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 173000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 173000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/37143606/pexels-photo-37143606.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/33696837/pexels-photo-33696837.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/8783116/pexels-photo-8783116.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 357000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 357000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/17160683/pexels-photo-17160683.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/186240/pexels-photo-186240.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/26238656/pexels-photo-26238656.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/4931355/pexels-photo-4931355.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 103000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 103000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/33696837/pexels-photo-33696837.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/5274524/pexels-photo-5274524.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        (SELECT sport_type_id FROM sport_types WHERE sport_name = 'Basketball'),
        'Sân bóng rổ', 'Dữ liệu thực tế tổng hợp từ OpenStreetMap.', 'FACILITY', complex_id,
        '06:00', '22:00', 267000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 267000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/8007173/pexels-photo-8007173.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/35984242/pexels-photo-35984242.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/5274524/pexels-photo-5274524.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/9488949/pexels-photo-9488949.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/30651230/pexels-photo-30651230.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/186240/pexels-photo-186240.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/32944292/pexels-photo-32944292.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/3660204/pexels-photo-3660204.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 98000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 98000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/27669822/pexels-photo-27669822.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/46792/the-ball-stadion-football-the-pitch-46792.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
new_facility AS (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        (SELECT sport_type_id FROM sport_types WHERE sport_name = 'Football'),
        'Sân bóng đá Mã Lò', 'Dữ liệu thực tế tổng hợp từ OpenStreetMap.', 'FACILITY', complex_id,
        '06:00', '22:00', 511000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 511000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/36127007/pexels-photo-36127007.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/9739462/pexels-photo-9739462.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
...
WITH new_complex AS (
    INSERT INTO stadium_complexes (
        ...
        'https://images.pexels.com/photos/27151849/pexels-photo-27151849.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    ) RETURNING complex_id
),
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/5666179/pexels-photo-5666179.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/6010279/pexels-photo-6010279.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 259000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 259000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/4328745/pexels-photo-4328745.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/47343/the-ball-stadion-horn-corner-47343.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Huy Sport Center'),
        ...
        '06:00', '22:00', 382000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 382000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
...
gallery_images AS (
    INSERT INTO stadium_complex_images (complex_id, image_url)
    SELECT complex_id, unnest(ARRAY['https://images.pexels.com/photos/13425628/pexels-photo-13425628.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', 'https://images.pexels.com/photos/5666179/pexels-photo-5666179.jpeg?auto=compress&cs=tinysrgb&h=650&w=940'])
    FROM new_complex
),
new_facility AS (
    INSERT INTO stadiums (
    ...
    SELECT (SELECT owner_id FROM owners WHERE business_name = 'Sport Venue Owner Corp'),
        ...
        '06:00', '22:00', 228000.00, 'AVAILABLE', 'APPROVED', 5.0, 0, NOW()
    FROM new_complex
    RETURNING stadium_id, complex_id
),
new_courts AS (
...
INSERT INTO time_slots (stadium_id, start_time, end_time, price_per_slot, slot_status)
SELECT stadium_id, make_time(h, 0, 0), make_time(h + 1, 0, 0), 228000.00, 'AVAILABLE'
FROM new_courts, generate_series(6, 21) AS h;
