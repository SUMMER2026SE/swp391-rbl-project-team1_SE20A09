...
interface OwnerDashboardClientProps {
  initialReport: RevenueReportResponse | null
  initialSummary: OwnerDashboardSummaryResponse | null
  initialPendingBookings: BookingItem[]
}
...
export default function OwnerDashboardClient({
  ...
  const [report, setReport] = useState<RevenueReportResponse | null>(initialReport);
  const [summary, setSummary] = useState<OwnerDashboardSummaryResponse | null>(initialSummary);
  const [pendingBookings, setPendingBookings] = useState<BookingItem[]>(initialPendingBookings);
  ...
  // Fetch all necessary dashboard data on refresh
  ...
  return (
    <div className="p-6 lg:p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-955 dark:text-white">Tổng quan hiệu suất</h1>
